      ...
      <div className="hero bg-[url('/src/assets/img/hero.jpg')] min-h-screen">
        <div className="hero-content text-center">
          <div className="max-w-md">
            ...
            <p className="py-6 ">
              Life's too short to eat bad food, savor every bite, and embrace
              the culinary adventure! A foodie's heart beats for flavor, from
              the first taste to the last, a true celebration of food.
            </p>
            <Link to={"RecipyList"}>
